...
namespace UIVersion
{
	...
	public:
		...
		void InitializeComponent(void)
		{
			...
			this->DiagMes_1->Text = L"неверный формат ввода данных";
			...
			this->WrongFileLabel->Text = L"неверный формат файла";
			...
			this->EmptyStructureLabel->Text = L"структура пуста, сохранение невозможно";
